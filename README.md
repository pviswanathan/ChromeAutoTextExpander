Google Chrome Extension : Auto Text Expander [![Build Status](https://travis-ci.org/carlinyuen/ChromeAutoTextExpander.svg?branch=master)](https://travis-ci.org/carlinyuen/ChromeAutoTextExpander)
=========================
